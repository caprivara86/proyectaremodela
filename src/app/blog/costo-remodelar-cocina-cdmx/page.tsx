      ...
      <section className="mx-auto max-w-4xl px-6 py-14 md:px-8 md:py-20">
        <nav aria-label="Breadcrumb" className="mb-8 text-sm text-white/60">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li>/</li>
            <li className="text-white/85">Costo de remodelar cocina en CDMX</li>
          </ol>
        </nav>
          ...
          <div className="mt-10 space-y-6">
            <section className="rounded-3xl border border-white/10 bg-black/10 p-6 md:p-7">
              <h2 className="text-2xl font-semibold tracking-tight text-white">
                Precio promedio de remodelar una cocina en CDMX
              </h2>
            ...
            <section className="rounded-3xl border border-white/10 bg-black/10 p-6 md:p-7">
              ...
              <ul className="mt-4 space-y-3 text-white/85">
                <li><Link href="/remodelacion-residencial/cocina" className="underline decoration-white/30 underline-offset-4 transition hover:text-white">Remodelación de cocina</Link></li>
                <li><Link href="/proyectos/proyecto-remodelacion-polanco" className="underline decoration-white/30 underline-offset-4 transition hover:text-white">Proyecto de remodelación en Polanco</Link></li>
